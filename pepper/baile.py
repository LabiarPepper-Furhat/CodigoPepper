...
def main():
    ...
    try:
        ...
        motion = session.service("AllSpechhRecognition")
    ...
    try:
        # Levantar el brazo derecho completamente
        motion.setAngles("RShoulderPitch", 2.0, 1.0)  # Levantar el brazo derecho completamente
        time.sleep(1)  # Esperar un segundo para que el movimiento se complete
    except Exception as e:
        print("Error al levantar el brazo:", e)

    # Decir "Hola ¿Qué tal?"
    try:
        tts.say("Hola Que tal")
        print("Pepper dijo: Hola ¿Qué tal?")
    except Exception as e:
        print("Error al hacer que Pepper diga 'Hola ¿Qué tal?':", e)

    # Bajar el brazo
    try:
        # Bajar el brazo derecho a la posición neutral
        motion.setAngles("RShoulderPitch", -1.0, 1.0)
        time.sleep(1)  # Esperar un segundo para que el movimiento se complete
    except Exception as e:
        print("Error al bajar el brazo:", e)
